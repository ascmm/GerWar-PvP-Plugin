package de.gerwar.pvp.splits.utils;
...
public class MarkdownFormatter
{
	 ...
	 */
	public static String buildMetricsMarkdown(List<PlayerMetrics> data, SplitsConfigKeys config)
	{
	 ...
	 */
	public static String buildMetricsJson(SplitService sessionManager)
	{
