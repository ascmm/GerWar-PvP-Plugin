...
import de.gerwar.pvp.splits.controllers.PanelActions;
import de.gerwar.pvp.splits.controllers.PanelController;
import de.gerwar.pvp.splits.models.Kill;
import de.gerwar.pvp.splits.models.Metrics;
import de.gerwar.pvp.splits.models.PlayerMetrics;
import de.gerwar.pvp.splits.models.RecentSplitsTable;
import de.gerwar.pvp.splits.models.Session;
import de.gerwar.pvp.splits.models.Transfer;
import de.gerwar.pvp.splits.models.WaitlistTable;
import de.gerwar.pvp.splits.utils.Formats;
import static de.gerwar.pvp.splits.utils.Formats.OsrsAmountFormatter.toSuffixString;
import de.gerwar.pvp.splits.utils.MarkdownFormatter;
import de.gerwar.pvp.splits.utils.PaymentProcessor;
import de.gerwar.pvp.splits.views.components.DropdownRip;
import de.gerwar.pvp.splits.views.components.table.RemoveButtonEditor;
import de.gerwar.pvp.splits.views.components.table.RemoveButtonRenderer;
...
@Getter
/**
 * Swing-based view for the GerWar PvP — Splits panel. Renders sections and forwards
 * user interactions to PanelActions.
 */
public class SplitsTabPanel extends PluginPanel
{
	private final JPanel activePlayersButtonsPanel = new JPanel(new GridLayout(0, 1, 0, 2));
	private final SplitService sessionManager;
	private final SplitsConfigKeys config;
	private final KnownPlayers playerManager;
	...
	public SplitsTabPanel(SplitService sessionManager, SplitsConfigKeys config, KnownPlayers playerManager, PanelController controller)
	{
