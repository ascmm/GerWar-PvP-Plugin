...
import de.gerwar.pvp.splits.views.PopoutView;
...
public class SplitsPanel
{
	...
	private final SplitService manager;
	 ...
	 */
	@Inject
	public SplitsPanel(SplitService sessionManager, SplitsConfigKeys config, KnownPlayers playerManager)
	{
	...
	private void startPanel()
	{
		...
		view = new SplitsTabPanel(manager, config, playerManager, controller);
	...
	private void togglePopOutWindow()
	{
		...
		popoutFrame = new JFrame("GerWar PvP — Splits");
