package de.gerwar.pvp.splits.views.components.table;
...
public class RemoveButtonEditor extends DefaultCellEditor
{
	...
	static
	{
		BufferedImage removeImg = ImageUtil.loadImageResource(RemoveButtonEditor.class, "/de/gerwar/pvp/splits/icons/trash-solid-full.png");
		REMOVE_ICON = new ImageIcon(ImageUtil.resizeImage(removeImg, 16, 16));
		BufferedImage addImg = ImageUtil.loadImageResource(RemoveButtonEditor.class, "/de/gerwar/pvp/splits/icons/trash-arrow-up-solid-full.png");
	...
	@Inject
	private SplitsPanel managerPanel;
	 ...
	 */
	public RemoveButtonEditor(Component parent, SplitService manager, JTable metricsTable, PanelActions actions)
	{
		super(new JCheckBox());
