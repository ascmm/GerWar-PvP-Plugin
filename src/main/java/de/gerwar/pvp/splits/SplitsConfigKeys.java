...
/**
 * The SplitsConfigKeys interface defines a configuration for the Split Manager plugin.
 ...
 */
@ConfigGroup(SplitsConfigKeys.GROUP)
public interface SplitsConfigKeys extends Config
{
